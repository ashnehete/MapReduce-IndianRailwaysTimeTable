...
public class TotalDistance {
	...
	public static class TokenizerMapper extends
		...
		public void map(Object key, Text value, Context context)
			...
			try {
				...
				if (tuple.stnCode.equals(tuple.destStn))
					context.write(new Text(tuple.srcStnName), new IntWritable(
						tuple.distance));
			} catch (Exception e) {
				e.printStackTrace();
			}
	...
	public static void main(String[] args) throws Exception {
		...
		FileOutputFormat.setOutputPath(job, new Path("outputTotalDistance"));
